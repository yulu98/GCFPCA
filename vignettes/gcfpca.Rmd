...
The plot below shows latent subject-specific means on the linear predictor scale, $\beta_0(s) + \sum_{r=1}^p X_{ir} \beta_r(s) + \sum_{l=1}^L \xi_{il} \phi_l(s)$, for three subjects in the simulated Binomial dataset. True values are black solid lines while GCFPCA estimates are pink dotted lines.
