...
We deleted all the missingness and subsetted 200 subjects to show our method.

```{r nhanes_process}
df_single <- readRDS("data/nhanes_fda_with_r.rds") %>%
  na.omit()

set.seed(123)  # Set seed for reproducibility
selected_ids <- sample(df_single$SEQN, 200)
...
eta_pffr <- matrix(pffr_model$linear.predictors, nrow = 200, ncol = 1440)
```
